...
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryAutoHU;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryDocument;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryHUHeader;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryHUItem;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryHeader;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryHeaderExtension;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryItem;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.InboundDeliveryItemExtension;
import customer.cnma_s4_integration_gateway.vdm.dnus.namespaces.asnsrv.MessageResponse;
import lombok.extern.slf4j.Slf4j;

@Slf4j
@Component
public class Dnus_PayloadMapper {
    ...
    public InboundDelivery buildPayloadCreateInboundDelivery(SubmitAsnPayload asnPayload){
        ...
        for (cds.gen.cnma.type.InboundDeliveryItem itemPayload: asnPayload.getInboundDelivery2Item()){
            ...
            // inboundDeliveryItem.setUnitOfQuantity(itemPayload.getUnitOfQuantity());// DNUS can automatically take the quantity unit from SAP backend
